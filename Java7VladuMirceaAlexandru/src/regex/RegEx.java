...
//^1|^2
        ...
        // DATA FORMAT YYYYMMDD CU BISECT SI VALIDARE: ^(?:\d{4}(?:(?:(?:(?:0[13578]|1[02])(?:0[1-9]|[1-2][0-9]|3[01]))|(?:(?:0[469]|11)(?:0[1-9]|[1-2][0-9]|30))|(?:02(?:0[1-9]|1[0-9]|2[0-8]))))|(?:(?:\d{2}(?:0[48]|[2468][048]|[13579][26]))|(?:(?:[02468][048])|[13579][26])00)(02)(29))$
         ...
         // data format yymmdd cu bisect si validare TEST  OK  ^(?:\d{2}(?:(?:(?:(?:0[13578]|1[02])(?:0[1-9]|[1-2][0-9]|3[01]))|(?:(?:0[469]|11)(?:0[1-9]|[1-2][0-9]|30))|(?:02(?:0[1-9]|1[0-9]|2[0-8]))))|(?:(?:[1-9][02468])(02)(29)))$

         
         //varianta 2 MERGE : ^((1|2)((1|2)(?:\d{2}(?:(?:(?:(?:0[13578]|1[02])(?:0[1-9]|[1-2][0-9]|3[01]))|(?:(?:0[469]|11)(?:0[1-9]|[1-2][0-9]|30))|(?:02(?:0[1-9]|1[0-9]|2[0-8]))))|(?:(?:(0|[1-9])[02468])(02)(29)))\d{6})$
         //1160229000000   -- MERGE 2016 ESTE AN BISECT
         // 1150229000000  -- NU MERGE, 2015 NU ESTE AN BISECT
         // 1850431000000 -- NU MERGE, APRILIE NU ARE 31 DE ZILE
         // 3850418000000 -- NU MERGE, INCEPE CU 3
         // 18504180000000 - NU MERGE DIMENSIUNE PESTE 13
         //1940229000000   -- MERGE DESI 1994 NU ESTE AN BISECT// ULTIMA PARTE A REGEX IA IN CALCUL ANI DE FORMA YY DIVIZIBILI CU 2, DIVIZIBIL CU 4 ELIMINA PREA MULTE VARINATE
    }
